...
namespace RBX
{
    public class Field
    {
        ...
        public Vector corner_left_top { get; set; }
        public Vector corner_right_top { get; set; }
        public Vector corner_left_bottom { get; set; }
        public Vector corner_rigth_bottom { get; set; }
        public Vector side_left_center { get; set; }
        public Vector side_top_center { get; set; }
        public Vector side_rigth_center { get; set; }
        public Vector side_bottom_center { get; set; }
